...
export const INITIAL_SESSIONS: WorkshopSession[] = [
  ...
  },
  {
    ...
    studentCountActual: 34,
    status: "pending_approval",
    sessionNotes: "تم إلقاء الورشة في قاعة التدريب التفاعلي بحضور 34 طالباً وتطبيق إنشاء الملفات مع الطلاب.",
    submittedForApprovalAt: "2026-08-26 12:45",
