...
export const INITIAL_WHITELIST: WhitelistEntry[] = [
  {
    ...
    phone: "0501234567",
    department: "البرمجة وعلوم الحاسب",
  ...
  },
  {
    ...
    phone: "0559876543",
    department: "التجارة الإلكترونية",
  ...
  },
  {
    ...
    phone: "0543322110",
    department: "إدارة اللوجستيات وسلاسل الإمداد",
    campus: "الزلفي",
    employeeId: "MU-47055",
    passcode: "MU@47055",
    status: "active",
  ...
  },
  {
    ...
    phone: "0567788990",
    department: "التصميم الجرافيكي والوسائط الرقمية",
    campus: "حوطة سدير",
    employeeId: "MU-51208",
    passcode: "MU@51208",
    status: "active",
  ...
  },
  {
    ...
    phone: "0531122334",
    department: "إدارة وتطوير العقار",
    campus: "رماح",
    employeeId: "MU-52990",
    passcode: "MU@52990",
    status: "active",
  ...
  },
  {
    ...
    phone: "0590011223",
    department: "تطوير تطبيقات الأجهزة الذكية",
    campus: "المجمعة (المقر الرئيسي)",
    employeeId: "MU-46881",
    passcode: "MU@46881",
    status: "active",
  ...
  {
    id: "fac-7",
    name: "أ.د. فيصل بن سعد القحطاني",
    title: "أستاذ دكتور",
    email: "f.alqahtani@mu.edu.sa",
    phone: "0509988776",
    department: "المحاسبة والضرائب",
    campus: "المجمعة (المقر الرئيسي)",
    employeeId: "MU-45120",
    passcode: "MU@45120",
    status: "active",
...
export const INITIAL_SESSIONS: WorkshopSession[] = [
  ...
  },
  {
    ...
    courseCode: "CGU-103",
    professorId: "fac-6",
    professorName: "د. إبراهيم بن محمد الرشيد",
    professorTitle: "أستاذ مساعد",
    professorEmail: "i.alrasheed@mu.edu.sa",
    professorPhone: "0590011223",
    department: "تطوير تطبيقات الأجهزة الذكية",
    campus: "المجمعة (المقر الرئيسي)",
    date: "2026-08-26",
  ...
  },
  {
    ...
    courseCode: "CGU-105",
    professorId: "fac-user",
    professorName: "د. رشاد المهني",
    professorTitle: "مستشار التوجيه المهني وعضو هيئة التدريس",
    professorEmail: "alarshadalmhani@gmail.com",
    professorPhone: "0505123456",
    department: "الموارد البشرية",
    campus: "المجمعة (المقر الرئيسي)",
    date: "2026-09-02",
